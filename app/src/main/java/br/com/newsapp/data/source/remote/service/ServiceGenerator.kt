...
import br.com.newsapp.TAG
import br.com.newsapp.data.source.remote.AuthInterceptor
import br.com.newsapp.data.source.remote.Resource
import br.com.newsapp.util.Preferences.DATE_FORMAT
...
class ServiceGenerator @Inject constructor() {
    ...
    fun okhttpClient(hasAuth: Boolean): OkHttpClient {

        val cookieManager = CookieManager()
        cookieManager.setCookiePolicy(CookiePolicy.ACCEPT_ALL)

        val interceptor = AuthInterceptor(hasAuth)
        val okHttpBuilder = OkHttpClient.Builder()

        okHttpBuilder.cookieJar(JavaNetCookieJar(cookieManager))
        okHttpBuilder.addInterceptor(interceptor)
        okHttpBuilder.addInterceptor(interceptor.loggerInterceptor)
    ...
    fun <S> createService(serviceClass: Class<S>, hasAuth: Boolean): S {
